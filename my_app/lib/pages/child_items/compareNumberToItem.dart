...
class CompareNumberToItemPage extends StatefulWidget {
  @override
  _CompareExactNumberPageState createState() => _CompareExactNumberPageState();
}

class _CompareExactNumberPageState extends State<CompareNumberToItemPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Exact Number Comparison'),
      ),
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              'Which side has exactly ${currentQuestion.targetNumber} items?',
